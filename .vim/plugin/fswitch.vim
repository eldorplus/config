...
augroup fswitch_au_group
    ...
    au BufEnter *.h call s:SetVariables('cpp,c', 'reg:/include/src/,reg:/include.*/src/,reg:|/include/|../src|')
    au BufEnter *.hpp call s:SetVariables('cpp', 'reg:/include/src/,reg:/include.*/src/,reg:|/include/|../src|')
    au BufEnter *.cpp call s:SetVariables('hpp,h', 'reg:/src/include/,reg:|src|include/**|,reg:|/src/|../include|')
augroup END
